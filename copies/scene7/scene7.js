...
export async function initializeScene7(existingRenderer, isVRMode) {
  ...
  // Determine best target from botBuilding with safe fallback
  const botTarget = (botBuilding && (botBuilding.lookAtPosition || botBuilding.position || (botBuilding.group && botBuilding.group.position))) || new THREE.Vector3(
    0.3733519425956795,
    2.0841573887741274,
    -2.8188746574795207
  );
  controls.target.copy(botTarget);
