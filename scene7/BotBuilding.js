...
export function BotBuilding(
  ...
  // Initialize subtitle and video systems
  ...
  const botBuildingSteps = [
    ...
    "Drag and drop the supporting clip to the blinking part position", //step22
    "Drag and drop the supporting clip to the blinking part position", //step23
    "Drag and drop the supporting clip to the blinking part position", //step24
    "Drag and drop the bot middle case to the blinking part position", //step25
    "Drag and drop the expansion board to the blinking part position", //step26
    "Connect the buck converter output wire to the power pin of the expansion board", //step27
    "Connect the other end of the motor driver input pin to the motor driver port of the expansion board", //step28
    "Drag and drop the bot front panel to the blinking part position", //step29
    "Drag and drop the left eye to the blinking part position", //step30
    "Drag and drop the right eye to the blinking part position", //step31
    "Drag and drop the left RGB module to the blinking part position", //step32
    "Drag and drop the right RGB module to the blinking part position", //step33
    "Drag and drop the Arduino Nano to the blinking part position", //step34
    "Connect the wire to the left RGB module", //step35
    "Connect the other end of the wire to the expansion board RGB port", //step36
    "Connect the wire to the right RGB module", //step37
    "Connect the other end of the wire to the expansion board RGB port", //step38
    "Drag and drop the top case to the blinking part position", //step39
    "Drag and drop the TSOP sensor to the blinking part position", //step40
    "Connect the wire to the TSOP sensor", //step41
    "Drag and drop the push button to the blinking part position", //step42
    "Connect the wire to the push button", //step43
    "Drag and drop the buzzer sensor to the blinking part position", //step44
    "Connect the wire to the buzzer sensor", //step45
    "Drag and drop the LDR sensor to the blinking part position", //step46
    "Connect the wire to the LDR sensor", //step47
    "Connect the other end of the wire from the TSOP sensor to the TSOP port of the expansion board", //step48
    "Connect the other end of the wire from the push button to the button port of the expansion board", //step49
    "Connect the other end of the wire from the buzzer to the buzzer port of the expansion board", //step50
    "Connect the other end of the wire from the LDR to the LDR port of the expansion board", //step51
    "Drag and drop the tyre case to the blinking part position", //step52
    "Drag and drop the tyre case to the blinking part position", //swtep53
    "Drag and drop the tyre case to the blinking part position", //step54
    "Drag and drop the tyre case to the blinking part position", //step55
    "Drag and drop the tyre to the blinking part position", //step56
    "Drag and drop the tyre to the blinking part position", //step57
    "Drag and drop the tyre to the blinking part position", //step58
    "Drag and drop the tyre to the blinking part position", //step59
  ];
  ...
  // Side panel initialized with the first step's mesh
  ...
  // Function to show completion sequence with subtitles and video
  ...
  function dispose() {
    ...
    // Dispose raycaster and sidepanel
    // sidepanelInstance.dispose();

    // Dispose all JstXhFemalePin instances if they exist
    const wires = [
      chargingModuleWire,
      batteryWire,
      motor1Wire,
    ...
    // Dispose all copied and original parts
    assembeldBotCopy.forEach((part) => disposeMesh(part.mesh));
    assembeldBotOrginal.forEach((part) => disposeMesh(part));
    wiresMap.forEach((part) => disposeMesh(part.mesh));
    botFemalePinsMap.forEach((part) => disposeMesh(part.mesh));
    botMalePinsMap.forEach((part) => disposeMesh(part.mesh));
    botTerminalsMap.forEach((part) => disposeMesh(part.mesh));

    // Clear maps
    assembeldBotCopy.clear();
    assembeldBotOrginal.clear();
    wiresMap.clear();
    botFemalePinsMap.clear();
    botMalePinsMap.clear();
    botTerminalsMap.clear();

    // Remove assembled bot from table
    if (assembeldBot.parent) assembeldBot.parent.remove(assembeldBot);
    ...
    // Add other nullifications if needed
  }
  function clearEverything() {
    sidepanelInstance.dispose();
    raycasterSetup.dispose();
