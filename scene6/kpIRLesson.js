...
import { setForwardArrowEnabled, enableCameraAnimation, runCodeButton, forwardArrow } from "./ui.js";
...
export function KpIRLesson(scene, camera) {
  ...
  async function InitialiseSteps() {
    ...
    function Step2() {
      ...
      try { window.jstPin = irJstPin; } catch (e) {}
    ...
    function Step4() {
      ...
      try { window.jstPin = motorJstPin; } catch (e) {}
    ...
    function Step5() {
      ...
      try { window.jstPin = motorDriverInputJstPin; } catch (e) {}
    ...
    function Step7() {
      ...
      try { window.jstPin = batteryWire1; } catch (e) {}
    ...
    function Step8() {
      ...
      try { window.jstPin = batteryWire2; } catch (e) {}
              ...
              () => {
                ...
                try {
                  ...
                  setTimeout(() => {
                    ...
                    if (scene && runCodeButton) {
                      if (!scene.children.includes(runCodeButton)) {
                        scene.add(runCodeButton);
                      }
                      runCodeButton.visible = true;
                      if (runCodeButton.traverse) {
