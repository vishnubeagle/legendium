...
import { setForwardArrowEnabled, setLesson, runCodeButton, forwardArrow } from "./ui.js";
...
export function cleanupKpRgbLesson(scene) {
  ...
  try {
    ...
    if (window.jstPin && window.jstPin.getGroup) {
      const jstPinGroup = window.jstPin.getGroup();
