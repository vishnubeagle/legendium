...
export class QuestionnaireUI {
  ...
  async loadQuestions() {
    // Get current lesson from global function or default to lesson1
    let currentLesson = typeof window.getCurrentLesson === 'function' ? window.getCurrentLesson() : 'lesson1';
    ...
    if (typeof window.getCurrentLesson !== 'function') {
      ...
      currentLesson = typeof window.getCurrentLesson === 'function' ? window.getCurrentLesson() : 'lesson1';
    }
    ...
    console.log('window.getCurrentLesson result:', window.getCurrentLesson ? window.getCurrentLesson() : 'function not found');
  ...
  showLessonContent() {
    ...
    console.log("Available global functions:", {
      ...
      getCurrentLesson: typeof window.getCurrentLesson
    });
