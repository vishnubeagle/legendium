...
const markers = [
  { type: 'portal', color: '#ff00ff', size: 10, position: { x: 2, y: 4, z: -60 } }, 
  { type: 'friend', color: '#ffffff', size: 8, position: { x: -14, y: 8, z: -12 } },     
  { type: 'hostile', color: '#f05454', size: 9, position: { x: -5, y: 2.25, z: -37.5 } },
  { type: 'hostile', color: '#f05454', size: 9, position: { x: -4, y: 6, z: 0 } }      
];
